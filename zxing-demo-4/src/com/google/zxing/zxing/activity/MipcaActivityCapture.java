...
//	};
	...
	static class MyHandler extends Handler {
		private WeakReference<MipcaActivityCapture> activityReference;

		public MyHandler(MipcaActivityCapture activity) {
			activityReference = new WeakReference<MipcaActivityCapture>(activity);
		}

		@Override
		public void handleMessage(Message msg) {
			MipcaActivityCapture activity = activityReference.get();
